            ...
            if (size === 1) {
                content.innerHTML += `
                    ...
                    <picture>   
                        ...
                        <img class="detail-img" src="./img/${element.galery[0]}" alt="${element.data}" type="image/webp" title="${element.titol}"/>
                    </picture>    
                `;
            } else {
                content.innerHTML += `
                ...
                <picture>   
                    ...
                    <img class="detail-img" src="./img/${element.galery[3]}" alt="${element.data}" type="image/png" title="${element.titol}"/>
                </picture>          
                `;
            }
        }

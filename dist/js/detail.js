...
})({"7vk8V":[function(require,module,exports) {
...
var _categoryJs = require("../data/category.js");
var _categoryJsDefault = parcelHelpers.interopDefault(_categoryJs);
var datosjson = (0, _categoryJsDefault.default);
function printDetail() {
    ...
    datosjson.forEach((element)=>{
        ...
        if (i == id) {
            ...
            var llistat = "";
            element.detall.llistat.forEach((e)=>{
                llistat += `<li>${e}</li>`;
            });
            content.innerHTML += `
                <header>
...
function relatedCategories(element, i) {
    ...
    datosjson.forEach((item)=>{
        j += 1;
        if (item.categoria === element.categoria && i != j) cat += `<li><a href="detail.html?id=${j}" id="${j}" class="cat-link2">${item.titol}</a></li>`;
    });
    return cat;
}
...
},{"../data/category.js":"jFdGT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jFdGT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const category = [
    {
        "titol": "Primera Lectura del Gui\xf3 a Wall Street",
        "lloc": "Nova York, Wall Street",
        ...
        "escenes": [
            "Reuni\xf3 en un despatx d'advocats",
            "Vistes als edificis emblem\xe0tics de Wall Street"
        ],
        "categoria": "Gravaci\xf3",
        "detall": {
            "text": "La primera lectura del gui\xf3 de SUITS va tenir lloc a Wall Street, amb els actors principals reunits en un despatx d'advocats real. La localitzaci\xf3 va establir el to aut\xe8ntic i sofisticat de la s\xe8rie, ambientada en el m\xf3n legal de Nova York. </br></br> En un hito que marc\xf3 el inicio de una serie que cautivar\xeda a millones, la primera lectura del gui\xf3n de Suits tuvo lugar en el emblem\xe1tico escenario de Wall Street. </br></br> El elenco principal, encabezado por Gabriel Macht, Patrick J. Adams y Meghan Markle, se reuni\xf3 en un aut\xe9ntico despacho de abogados, estableciendo as\xed el tono sofisticado y aut\xe9ntico que caracterizar\xeda a la serie ambientada en el competitivo mundo legal de Nueva York. Este evento, que tuvo lugar el 12 de febrero de 2010, no solo marc\xf3 el comienzo de la producci\xf3n, sino que tambi\xe9n simboliz\xf3 la colaboraci\xf3n \xfanica entre los actores y consultores legales reales. </br></br> La participaci\xf3n de miembros del reparto original, combinada con la asesor\xeda de expertos legales, sent\xf3 las bases para la autenticidad que definir\xeda Suits. Las primeras escenas emblem\xe1ticas grabadas durante esta lectura inicial se convertir\xedan en momentos ic\xf3nicos de la serie, consolidando as\xed la posici\xf3n de Suits como un referente en el g\xe9nero legal televisivo. Desde aquel d\xeda en Wall Street, la serie se embarc\xf3 en un viaje lleno de intriga, drama y \xe9xitos, gan\xe1ndose un lugar especial en el coraz\xf3n de los fan\xe1ticos del drama legal.",
            "llistat": [
                "Participaci\xf3 de membres del repartiment original",
                "Col\xb7laboraci\xf3 amb advocats consultors",
                "Enregistrament de les primeres escenes emblem\xe0tiques"
            ],
            "multimedia": "harvymike.jpg",
    ...
    {
        "titol": "El Desafiament Legal de Harvey Specter",
        "lloc": "Despatx Pearson Hardman",
        "data": "12 de desembre de 2012",
        "actors": [
            "Sarah Rafferty (Donna Paulsen)",
            "Gabriel Macht (Harvey Specter)"
        ],
        "escenes": [
            "Temporada 7, Episodi 15"
        ],
        "categoria": "News",
        "detall": {
            "text": "Harvey Specter es veu obligat a defensar un cas complex que posa a prova les seves habilitats legals. La trama es desenvolupa al despatx Pearson Hardman, amb una intensitat que mant\xe9 als espectadors al voral del seu seient. Sarah Rafferty, que interpreta a Donna, destaca en aquest episodi amb una actuaci\xf3 memorable. Les escenes estan carregades d'emoci\xf3 i estrat\xe8gies legals impressionants. <br><br> Harvey Specter es veu obligat a defensar un cas complex que posa a prova les seves habilitats legals. La trama es desenvolupa al despatx Pearson Hardman, amb una intensitat que mant\xe9 als espectadors al voral del seu seient. Sarah Rafferty, que interpreta a Donna, destaca en aquest episodi amb una actuaci\xf3 memorable. Les escenes estan carregades d'emoci\xf3 i estrat\xe8gies legals impressionants. <br><br> Harvey Specter es veu obligat a defensar un cas complex que posa a prova les seves habilitats legals. La trama es desenvolupa al despatx Pearson Hardman, amb una intensitat que mant\xe9 als espectadors al voral del seu seient. Sarah Rafferty, que interpreta a Donna, destaca en aquest episodi amb una actuaci\xf3 memorable. Les escenes estan carregades d'emoci\xf3 i estrat\xe8gies legals impressionants.",
            "llistat": [
                "Mike Ross's legal blog reaches one million subscribers",
                "Digital sensation in the online legal community",
                "Exploring technology's role in the legal world"
            ],
            "multimedia": "harvy.jpg",
            "video": "https://www.youtube.com/embed/-J29deLskPM?si=UgE99QQak7KLL9xy",
            "authorvideo": "https://www.youtube.com/@motivacionyliderazgoparaau1366",
            "authorname": "@motivacionyliderazgoparaau1366"
        }
    },
    {
        "titol": "Louis Litt: A Voice for Justice",
        "lloc": "Zane Specter Litt Wheeler Williams Law Firm",
        "data": "April 22, 2019",
        "actors": [
        ...
        "detall": {
            ...
            "llistat": [
                "Evolution of Louis Litt's character",
                "Rick Hoffman's nuanced portrayal",
                "Louis's resilience in facing legal challenges"
            ],
            "multimedia": "boss.jpg",
    ...
    {
        "titol": "Mike Ross's Confrontation",
        "lloc": "New York Bar Association",
        "data": "January 18, 2016",
        "actors": [
        ...
        "categoria": "News",
        "detall": {
            "text": "In a riveting courtroom scene, Mike Ross faces a formidable opponent at the New York Bar Association. The tension is palpable as Mike's legal skills and the intricacies of his fraudulent law career are put under the microscope.<br><br> Patrick J. Adams's performance in this confrontation is nothing short of gripping, capturing the emotional turmoil of a character on the brink. The scene raises ethical questions and explores the consequences of Mike's actions, adding a layer of moral complexity to the series.<br><br> Viewers were left on the edge of their seats, contemplating the fate of Mike Ross and the potential fallout for Pearson Specter Litt. This episode became a turning point, marking a shift in the series' narrative and the destiny of its central characters.",
            "llistat": [
                "Mike's courtroom confrontation",
                "Patrick J. Adams's gripping performance",
                "Ethical questions and consequences"
            ],
            "multimedia": "suite.jpg",
            "video": "https://www.youtube.com/embed/ImEnWAVRLU0",
            "authorvideo": "https://www.youtube.com/@motivacionyliderazgoparaau1366",
            "authorname": "@motivacionyliderazgoparaau1366"
        }
    },
    {
        "titol": "Donna Paulsen: The Heart of Pearson Specter Litt",
        "lloc": "Pearson Specter Litt",
        "data": "March 2, 2017",
        "actors": [
            "Sarah Rafferty (Donna Paulsen)"
        ],
        ...
        "categoria": "Anecdote",
        "detall": {
            "text": "Donna Paulsen, the brilliant legal secretary at Pearson Specter Litt, continues to be the heart of the firm. Her quick wit, unmatchable organizational skills, and unwavering loyalty have made her a fan favorite since the inception of the series.<br><br> Viewers have witnessed Donna's evolution from a secretary to a key player in the firm's success. Her iconic catchphrase 'What can I say? I'm Donna' has become synonymous with her character, reflecting her confidence and competence. Sarah Rafferty's portrayal of Donna has been a standout, earning acclaim for bringing depth and authenticity to the character.<br><br> Whether she's offering sage advice to Harvey or navigating the complexities of office dynamics, Donna Paulsen remains an integral and beloved part of the SUITS universe, making every scene she's in a memorable one.",
            "llistat": [
                "Donna's character evolution",
                "Iconic catchphrase moments",
                "Sarah Rafferty's portrayal"
            ],
            "multimedia": "mike.jpg",
            "video": "https://www.youtube.com/embed/ImEnWAVRLU0",
            "authorvideo": "https://www.youtube.com/@motivacionyliderazgoparaau1366",
    ...
    {
        "titol": "Louis Litt's Unforgettable Speech",
        "lloc": "Zane Specter Litt Wheeler Williams",
        ...
        "categoria": "Anecdota",
        "detall": {
            "text": "Louis Litt, the quirky and ambitious lawyer, delivers an unforgettable speech that leaves a lasting impact on Zane Specter Litt Wheeler Williams. In a rare display of vulnerability, Louis opens up about his journey, struggles, and the relentless pursuit of justice.<br><br> Rick Hoffman's performance in this scene is nothing short of stellar, capturing the essence of Louis's character with emotional depth and authenticity. The heartfelt monologue not only showcases Louis's growth throughout the series but also resonates with viewers on a profound level.<br><br> This standout moment became a highlight of the final season, symbolizing the culmination of Louis Litt's character arc. Fans praised the writing, direction, and Hoffman's portrayal, cementing this scene as one of the most memorable in the SUITS series.",
            "llistat": [
                "Louis's impactful speech",
                "Rick Hoffman's standout performance",
                "Culmination of Louis's character arc"
            ],
            "multimedia": "welcome.jpg",
            "video": "https://www.youtube.com/embed/ImEnWAVRLU0",
            "authorvideo": "https://www.youtube.com/@motivacionyliderazgoparaau1366",
            "authorname": "@motivacionyliderazgoparaau1366"
        }
    ...
    {
        "titol": "Mike Ross's Legal Blog Hits Milestone",
        "lloc": "Online",
        "data": "June 8, 2016",
        "actors": [
            "Patrick J. Adams (Mike Ross)"
    ...
    {
        "titol": "Harvey Specter Receives Legal Eagle Award",
        "lloc": "New York City",
        "data": "October 10, 2015",
        "actors": [
            "Gabriel Macht (Harvey Specter)"
        ],
        "escenes": [
        ...
        "detall": {
            ...
            "llistat": [
                "Harvey Specter honored with Legal Eagle Award",
                "Star-studded ceremony in NYC",
                "Impact of SUITS on legal drama"
            ],
            "multimedia": "boss.jpg",
    ...
    {
        "titol": "Inauguraci\xf3n del Estudio de Grabaci\xf3n para la Serie 'Suits'",
        "lloc": "Los \xc1ngeles, California",
        "data": "5 de mayo de 2011",
        "actors": [
            "Gabriel Macht",
            "Patrick J. Adams",
            "Meghan Markle"
        ...
        "escenes": [
            ...
            "Recorrido por los nuevos estudios"
        ],
        "categoria": "Gravaci\xf3",
        "detall": {
            "text": "La emocionante inauguraci\xf3n del nuevo estudio de grabaci\xf3n para la serie 'Suits' tuvo lugar en Los \xc1ngeles, California. El evento cont\xf3 con la presencia de los talentosos actores principales: Gabriel Macht, Patrick J. Adams y Meghan Markle. </br></br> Durante la inauguraci\xf3n, el elenco particip\xf3 en entrevistas exclusivas sobre la nueva temporada y la evoluci\xf3n de la trama. Los estudios, equipados con la \xfaltima tecnolog\xeda cinematogr\xe1fica, proporcionar\xedan el escenario perfecto para las futuras grabaciones de la serie. </br></br> El 5 de mayo de 2011 marc\xf3 un hito importante en la producci\xf3n de 'Suits', ya que el elenco y el equipo celebraron la expansi\xf3n de sus operaciones en la soleada Los \xc1ngeles. La apertura del nuevo estudio prometi\xf3 llevar la calidad de producci\xf3n a nuevos niveles y emocionar a los fans con intrigantes episodios llenos de drama y estilo legal \xfanico.",
            "llistat": [
                "Entrevistas exclusivas con el elenco",
                "Recorrido por los estudios de grabaci\xf3n",
                "Celebraci\xf3n de la expansi\xf3n a Los \xc1ngeles"
            ],
            "multimedia": "welcome.jpg",
            "video": "https://www.youtube.com/embed/9rg7efddG2U",
            "authorvideo": "https://www.youtube.com/@motivacionyliderazgoparaau1366",
            "authorname": "@motivacionyliderazgoparaau1366"
        }
    }
...
},{}]},["7vk8V","1xC6H","Tm9d6"], "Tm9d6", "parcelRequirea87c")

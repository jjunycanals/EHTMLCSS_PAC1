...
})({"33aJu":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7ff48f6ac01d9dc3";
"use strict";
...
},{}],"5Y4re":[function(require,module,exports) {
function printCat() {
    const content = document.getElementById("grid-cat");
    fetch(datosjson).then((response)=>response.json()).then((data)=>{
        var i = 0;
        if (content) data.forEach((element)=>{
            i += 1;
            content.innerHTML += `
                        <article class="category">
                            ...
                            <div class="cat-body">
                                ...
                                <h2>${element.titol}</h2>
                                <a href="detail.html?id=${i}" id="${i}" class="cat-link">M\xe9s informaci\xf3</a>
                            </div>
                        </article>
                    `;
        });
...
},{}]},["33aJu","1xC6H","5Y4re"], "5Y4re", "parcelRequirea87c")

//# sourceMappingURL=categoryjson.js.map
